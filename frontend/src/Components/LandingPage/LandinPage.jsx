  ...
  return (
    <div>
      ...
      <p className={style.p3}>
        ...
        de Rosario. Con más de 8 años de experiencia en la elaboración, venta y
        distribución de medallones veganos y vegetarianos. Contamos con tres
        tipos de alimentos base (Soja, Garbanzo, Arvejas) y 8 rellenos. Nuestros
        medallones constituyen un alimento saludable y completo, además de ser
        súper sabrosos y con rellenos abundantes. Nuestra experiencia en la
        cocina y el trato directo y personalizado con cada cliente, nos ha
        permitido mejorar nuestros medallones día a día, para así lograr un
        producto que cumple ampliamente con las expectativas, se recomienda y se
        vuelve a elegir. Sin embargo, las palabras se las lleva el viento así
        que los invitamos a probar los Medallones Cané y a simplemente disfrutar
        …”
      </p>
