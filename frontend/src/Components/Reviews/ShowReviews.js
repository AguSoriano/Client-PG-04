    ...
    <div className={style.container} key={prodDetail.id}>
      <div className={style.wrapper}>
        <div className={style.headReviews}>
          <h5>
            <strong>{/* totalreviews */}Opiniones acerca de:</strong>{" "}
          </h5>
          <h5 className={style.title}>
            <strong>{prodDetail.name}</strong>{" "}
          </h5>
          <h5 className={style.starsProm}>
            <Rating rating={value} />
          </h5>
        </div>
        <hr />
        ...
        {isAuthenticated ? (
          <div>
            <h5>
              ¿Cu&aacute;ntas estrellas crees que merece nuestro producto?:{" "}
              <strong>{prodDetail.name}</strong>{" "}
            </h5>
            <div className={style.stars}>
              {stars.map((_, index) => {
